...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class RelationalEntityTypeBuilderExtensions
    {
        ...
        public static TableValuedFunctionBuilder ToFunction(
            [NotNull] this EntityTypeBuilder entityTypeBuilder,
            [CanBeNull] string name)
        {
            Check.NotNull(entityTypeBuilder, nameof(entityTypeBuilder));
            ...
            return CreateFunctionBuilder(name, entityTypeBuilder.Metadata);
        }
            ...
            [NotNull] Action<TableValuedFunctionBuilder> configureFunction)
        {
            ...
            configureFunction(entityTypeBuilder.ToFunction(name));
        ...
        /// <param name="name"> The name of the function. </param>
        /// <returns> The function configuration builder. </returns>
        public static TableValuedFunctionBuilder ToFunction<TEntity>(
            [NotNull] this EntityTypeBuilder<TEntity> entityTypeBuilder,
            [CanBeNull] string name)
            where TEntity : class
            => ToFunction((EntityTypeBuilder)entityTypeBuilder, name);
            ...
            [CanBeNull] string name)
        {
            ...
            return CreateFunctionBuilder(name, ownedNavigationBuilder.OwnedEntityType);
        }
            ...
            [NotNull] Action<TableValuedFunctionBuilder> configureFunction)
        {
            ...
            configureFunction(ownedNavigationBuilder.ToFunction(name));
        ...
        /// <param name="name"> The name of the function. </param>
        /// <returns> The function configuration builder. </returns>
        public static TableValuedFunctionBuilder ToFunction<TEntity, TRelatedEntity>(
            [NotNull] this OwnedNavigationBuilder<TEntity, TRelatedEntity> referenceOwnershipBuilder,
            [CanBeNull] string name)
            where TEntity : class
            where TRelatedEntity : class
        ...
        private static TableValuedFunctionBuilder CreateFunctionBuilder(string name, IMutableEntityType entityType)
        {
            entityType.SetFunctionName(name);

            var model = entityType.Model;
            var function = model.FindDbFunction(name)
                ?? model.AddDbFunction(name, typeof(IQueryable<>).MakeGenericType(entityType.ClrType));

            return new TableValuedFunctionBuilder(function);
        }
