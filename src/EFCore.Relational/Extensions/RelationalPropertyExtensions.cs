...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class RelationalPropertyExtensions
    {
        ...
        /// <summary>
        ///     Returns the function column corresponding to this property if it's mapped to the given function.
        /// </summary>
        /// <param name="property"> The property. </param>
        /// <param name="functionName"> The target function name. </param>
        /// <returns> The function column to which the property is mapped. </returns>
        public static IFunctionColumn FindFunctionColumn([NotNull] this IProperty property, [NotNull] string functionName)
            => property.GetFunctionColumnMappings().Select(m => m.Column)
                .FirstOrDefault(c => c.Function.ModelName == functionName);
